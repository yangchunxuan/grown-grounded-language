...
Code \& data: all source, the hand-coded world, the experiment runners, and every banked verdict JSON are openly available at \url{https://github.com/yangchunxuan/grown-grounded-language}; every result regenerates via the commands in the Appendix. A citable archival release (DOI) will be deposited on acceptance.\\
