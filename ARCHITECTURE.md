...
|---|---|---|---|
| `rtc_g1f_coevolve.py` (`_run_arm`) | g1f | survival-selected channel, 5 arms | `rtc_g1f_commblind_verdict_formal48_rngfix.json` @5a6885a (embedded base `254f3d7`, `git_dirty`; sole headline source) + `rtc_g1f_lineage_share_verdict.json`; legacy `..._formal48.json` / `..._reconciled` / `..._power_analysis` = superseded |
